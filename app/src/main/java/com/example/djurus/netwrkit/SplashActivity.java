...
public class SplashActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        attendeeList.add( new Person("Patrick Pattington","Education","Engineer", "Khan Academy","Fashion",37.868647,-122.262700));
        ...
        attendeeList.get(attendeeList.size()-1).setImgSrc("philip");
        ...
        attendeeList.get(attendeeList.size()-1).setImgSrc("martin");
        ...
        attendeeList.get(attendeeList.size()-1).setSkills("Photoshop, Sketch");
        ...
        attendeeList.get(attendeeList.size()-1).setSkills("Frontend Web Development");
        attendeeList.add( new Person("Wilson Wong","Technology","Consultant", "Accenture","Basketball",37.868931, -122.262595));
        attendeeList.add( new Person("Nancar Nguyen","Education","Designer", "IDEO","Social Media",37.868711, -122.262280));
        attendeeList.get(attendeeList.size()-1).setImgSrc("nancar");
        ...
        attendeeList.get(attendeeList.size()-1).setImgSrc("ajay");
